...
if __name__ == "__main__":
    ...
    print("1. estimated_dividend_yield : " + estimated_dividend_yield)
    re_estimated_dividend_yield = estimated_dividend_yield.replace(",","")
    current_3year_treasury = get_current_3year_treasury()
    print("2. current_3year_treasury : " + current_3year_treasury)
    ...
    print("4. get_estimated_dividend_yield('058470')" + get_estimated_dividend_yield('058470'))
    print("5. get_current_3year_treasury()" + get_current_3year_treasury())
